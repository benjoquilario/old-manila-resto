      ...
      <div className="mx-auto flex h-[62px] w-full max-w-screen-2xl items-center justify-between gap-4 px-[4%] md:h-[74px] 2xl:h-[86px]">
        <Link href="/" className="text-lg font-semibold text-primary">
          <div className="flex items-center">
            ...
            <span className="ml-[-1px]">anila</span>
          </div>
        </Link>
        <div className="flex h-12 items-center justify-between gap-3">
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        item.href.startsWith(`/${segment}`)
                          ...
                          : "text-foreground/60 hover:text-foreground/80 font-normal"
                      )}
                    >
                      {item.title}
                    </Link>
          ...
          <HeaderMenu
            className={cn(
              isOpen
                ? "visible right-0 top-0 z-[99999] bg-white opacity-100"
          ...
          <div className="flex gap-2">
            <Toggle
              ...
              variant="outline"
              className="z-[999999] block md:hidden"
            >
              {isOpen ? (
